...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../Lab_13.srcs/sources_1/ip/snake_G/sim/snake_G.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.snake_G xil_defaultlib.glbl -o snake_G_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./snake_G_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key snake_G_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc snake_G_simv.daidir)
