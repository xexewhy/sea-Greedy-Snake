...
HD_PWD='C:/Users/DELL/Desktop/xilinx_uart/xilinx_uart_final/drawsnake/Lab_13.runs/snake_G_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_G.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_G.tcl
