...
HD_PWD='C:/Users/DELL/Desktop/xilinx_uart/xilinx_uart_final/drawsnake/Lab_13.runs/apple_R_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apple_R.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apple_R.tcl
