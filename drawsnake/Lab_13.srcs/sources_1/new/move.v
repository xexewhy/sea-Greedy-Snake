...
(
	...
	localparam NORMALSPEED = 32'd20000000;
	localparam CRAZYSPEED = 32'd10000000;
	...
	assign SPEED=(key_state==2)? NORMALSPEED:CRAZYSPEED;  
	...
	always @(posedge clk or negedge rst) begin
		if(!rst) begin
			...
			cnt <= cnt + 1;
			if(cnt == SPEED ) begin   //0.02us*12'500'000=0.25s   每秒移动四次
				cnt <= 0;
...
//吃下苹果没？，吃下则add_cube==1，显示体长增加一位，"is_exixt[cube_num]<=1",让第cube_num位"出现"		
	...
	always @(x_pos or y_pos ) begin				
		if(x_pos >= 0 && x_pos < 1280 && y_pos >= 0 && y_pos < 960) begin
			if(x_pos[10:5] == 0 | y_pos[10:5] == 0 | x_pos[10:5] == 39 | y_pos[10:5] == 29)
				snake = WALL;//扫描墙
			else if(x_pos[10:5] == cube_x[0] && y_pos[10:5] == cube_y[0] && is_exist[0] == 1) 
				snake = (die_flash == 1) ? HEAD : NONE;//扫描头
			else if
				((x_pos[10:5] == cube_x[1] && y_pos[10:5] == cube_y[1] && is_exist[1] == 1)|
				 (x_pos[10:5] == cube_x[2] && y_pos[10:5] == cube_y[2] && is_exist[2] == 1)|
				 (x_pos[10:5] == cube_x[3] && y_pos[10:5] == cube_y[3] && is_exist[3] == 1)|
				 (x_pos[10:5] == cube_x[4] && y_pos[10:5] == cube_y[4] && is_exist[4] == 1)|
				 (x_pos[10:5] == cube_x[5] && y_pos[10:5] == cube_y[5] && is_exist[5] == 1)|
				 (x_pos[10:5] == cube_x[6] && y_pos[10:5] == cube_y[6] && is_exist[6] == 1)|
				 (x_pos[10:5] == cube_x[7] && y_pos[10:5] == cube_y[7] && is_exist[7] == 1)|
				 (x_pos[10:5] == cube_x[8] && y_pos[10:5] == cube_y[8] && is_exist[8] == 1)|
				 (x_pos[10:5] == cube_x[9] && y_pos[10:5] == cube_y[9] && is_exist[9] == 1)|
				 (x_pos[10:5] == cube_x[10] && y_pos[10:5] == cube_y[10] && is_exist[10] == 1)|
				 (x_pos[10:5] == cube_x[11] && y_pos[10:5] == cube_y[11] && is_exist[11] == 1)|
				 (x_pos[10:5] == cube_x[12] && y_pos[10:5] == cube_y[12] && is_exist[12] == 1)|
				 (x_pos[10:5] == cube_x[13] && y_pos[10:5] == cube_y[13] && is_exist[13] == 1)|
				 (x_pos[10:5] == cube_x[14] && y_pos[10:5] == cube_y[14] && is_exist[14] == 1)|
				 (x_pos[10:5] == cube_x[15] && y_pos[10:5] == cube_y[15] && is_exist[15] == 1))
